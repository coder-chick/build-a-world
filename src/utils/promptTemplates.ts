...
Ensure the animated video uses an anime style with vibrant cartoony animation techniques, ensuring the content is completely safe, family-friendly, and avoids any suggestive or inappropriate material. The product we are showcasing MUST be prominently visible and clearly featured in the animated video.
Crucially, ALWAYS refer to the subject in your prompts as "the product in the provided image". Do not invent product names or specific features that might conflict with the provided image.
