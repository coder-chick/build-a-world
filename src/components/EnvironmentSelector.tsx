...
// ─────────────────────────────────────────────────────────────────────────────
// OWNER: TEAM 1
// EnvironmentSelector — lets the user pick a shooting environment that will
// be applied to all three product images AND all Seedance video prompts.
// ─────────────────────────────────────────────────────────────────────────────
...
export const ENVIRONMENTS: EnvironmentPreset[] = [
  {
    ...
    promptSuffix:
      'clean white cyclorama studio, soft-box lighting, professional product photography, pure white background, sharp shadows',
  ...
  },
  {
    ...
    promptSuffix:
      'dark moody studio environment, dramatic rim lighting, deep shadows, cinematic noir aesthetic, black background, teal accent light',
  ...
  },
  {
    ...
    promptSuffix:
      'urban city street environment, neon sign reflections on wet pavement, city lights bokeh, concrete textures, authentic street photography',
  ...
  },
  {
    ...
    promptSuffix:
      'golden hour outdoor setting, warm sunlight at 15 degrees, long shadows, natural organic environment, aspirational lifestyle feel',
  ...
  },
  {
    ...
    promptSuffix:
      'luxury white marble surface, soft diffused studio lighting, gold and chrome accents, premium editorial product photography, high fashion aesthetic',
  ...
  },
  {
    ...
    promptSuffix:
      'infinite digital void, holographic particle effects, floating in cyberspace, glowing neon grid lines, sci-fi abstract environment, translucent surfaces',
